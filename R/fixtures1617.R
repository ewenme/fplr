...
#'  \item{kickoff_time_formatted}{kick-off time}
#'  \item{event_day}{day of event/round of fixtures}
#'  \item{stats}{list of in-game events}
...
#'  \item{finished}{Logical indicating if fixture is finished}
#'  \item{minutes}{No. minutes of fixture played}
